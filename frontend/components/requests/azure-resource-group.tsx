...
import { ResourceGroupAccordionST } from "./azure-resource-group-accordion/azure-resource-group-accordion-st"
import { ResourceGroupAccordionVM } from "./azure-resource-group-accordion/azure-resource-group-accordion-vm"
import { ResourceGroupAccordionDB } from "./azure-resource-group-accordion/azure-resource-group-accordion-db"
...
export default function AzureResourceGroup({
  form,
  cloudProvider,
  setCloudProvider,
  dbPolicy,
          ...
          <div>
            <div className="flex gap-6">
              ...
              <Input
                ...
                min={0}
                onChange={(e) => {
                  setVmCount(Number(e.target.value))
                  form.setError("resources.resourceConfig", {
                    message:
          ...
          <div className="">
            <div className="flex gap-6">
              ...
              <Input
                ...
                min={0}
                onChange={(e) => {
                  setStorageCount(Number(e.target.value))
                  form.setError("resources.resourceConfig", {
                    message:
                      "At least one resource (VM, Database, or Storage) is required",
                  })
          ...
          <div className="">
            <div className="flex gap-6">
              ...
              <Input
                ...
                min={0}
                onChange={(e) => {
                  setDatabaseCount(Number(e.target.value))
                  form.setError("resources.resourceConfig", {
                    message:
                      "At least one resource (VM, Database, or Storage) is required",
                  })
